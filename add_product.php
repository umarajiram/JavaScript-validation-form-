                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_product" type="text" name="productna" class="form-control" placeholder="Please enter product name*" required="required" data-error="product name is required.">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Cost*</label>
                            <input id="form_cost" type="number" name="cost" class="form-control" placeholder="Please enter the product cost" required="required" data-error="Lastname is required.">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_model" type="text" name="model" class="form-control" placeholder="Please enter the modle_no">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input id="form_quantity" type="text" name="category" class="form-control" placeholder="Please enter the product category *" required="required" data-error="Valid quantity is required.">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_model" type="text" name="sub_category" class="form-control" placeholder="Please enter the product sub-category">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
